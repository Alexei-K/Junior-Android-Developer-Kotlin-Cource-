...
/**
 * ВНИМАНИЕ!!!
 * 10-12 главы пропускаем
 * К 11 и 12 главам вернемся, когда они понадобятся в изучении андроида.
 * После этой главы переходите на 446 страницу учебника (Топ 10 тем).
 * Можете посмотреть все темы, но вникнуть стоит в темы № 2,3,6,7. По ним будут задания в package top10
 */
